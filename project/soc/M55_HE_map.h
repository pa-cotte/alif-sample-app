...
#define SRAM2_BASE (0x58000000UL)
#define SRAM2_SIZE 0x00040000 /* 256K */
#define SRAM3_BASE (0x58800000UL)
#define SRAM3_SIZE 0x00040000 /* 256K */
...
#define DTCM_SIZE (SRAM3_SIZE) /* 256K */
...
#define M55_CFG_BASE (0x43007000UL)
