...
Model version: 13
Edge Impulse SDK version: v1.80.0
...
Check if the revision of the `edge-impulse-sdk-zephyr` module in your manifest file matches with the one needed for this model which is v1.80.0.
