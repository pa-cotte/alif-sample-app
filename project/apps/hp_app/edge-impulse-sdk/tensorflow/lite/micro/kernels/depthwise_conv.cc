...
namespace tflite
{
  namespace
  {
                                        ...
                                        TfLiteEvalTensor *output)
    {
      ...
      if (dilation_width_factor == 1 && dilation_height_factor == 1)
      {
        ...
        data_dims_t input_dims = {
            .width = input_width, .height = input_height, .channels = input_depth, .extra = 1};
        data_dims_t output_dims = {
            .width = output_width, .height = output_height, .channels = output_depth, .extra = 1};
        data_dims_t filter_dims = {
            .width = filter_width, .height = filter_height, .channels = 0, .extra = 0};
    ...
    TfLiteStatus Prepare(TfLiteContext *context, TfLiteNode *node)
    {
      ...
      {
        data_dims_t input_dims = {
            .width = input_width, .height = input_height, .channels = input->dims->data[3], .extra = 1};
        data_dims_t output_dims = {
            .width = output_width, .height = output_height, .channels = output->dims->data[3], .extra = 1};
        data_dims_t filter_dims = {
            .width = filter_width, .height = filter_height, .channels = 0, .extra = 0};
        dw_conv_params_t conv_params = {
