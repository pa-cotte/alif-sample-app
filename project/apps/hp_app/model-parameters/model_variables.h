...
#include "tflite-model/tflite_learn_833783_4.h"
...
ei_dsp_config_spectral_analysis_t ei_dsp_config_833783_3 = {
    3, // uint32_t blockId
...
const ei_config_tflite_graph_t ei_config_graph_833783_4 = {
    .implementation_version = 1,
    .model = tflite_learn_833783_4,
    .model_size = tflite_learn_833783_4_len,
    .arena_size = tflite_learn_833783_4_arena_size
};

const uint8_t ei_output_tensors_indices_833783_4[1] = { 0 };
const uint8_t ei_output_tensors_size_833783_4 = 1;
ei_learning_block_config_tflite_graph_t ei_learning_block_config_833783_4 = {
    .implementation_version = 1,
    .block_id = 4,
    .output_tensors_indices = ei_output_tensors_indices_833783_4,
    .output_tensors_size = ei_output_tensors_size_833783_4,
    .quantized = 1,
    .compiled = 0,
    .graph_config = (void*)&ei_config_graph_833783_4,
    .dequantize_output = 0,
};
...
const ei_learning_block_t ei_learning_blocks_833783_2[ei_learning_blocks_833783_2_size] = {
    {
        4,
        &run_nn_inference,
        (void*)&ei_learning_block_config_833783_4,
        EI_CLASSIFIER_IMAGE_SCALING_NONE,
        ei_learning_block_833783_4_inputs,
        ei_learning_block_833783_4_inputs_size,
    },
};

ei_fill_result_classification_i8_config_t ei_fill_result_classification_i8_config_833783_4 = {
    .zero_point = -128,
    .scale = 0.00390625
};

const size_t ei_postprocessing_blocks_833783_2_size = 1;
const ei_postprocessing_block_t ei_postprocessing_blocks_833783_2[ei_postprocessing_blocks_833783_2_size] = {
    {
        .block_id = 4,
        ...
        .display_fn = NULL,
        .config = (void*)&ei_fill_result_classification_i8_config_833783_4,
        .input_block_id = 4
    },
};

const uint8_t freeform_outputs_833783_2_size = 0;

uint32_t *freeform_outputs_833783_2 = nullptr;

const ei_impulse_t impulse_833783_2 = {
    .project_id = 833783,
    .project_owner = "Rizelaine",
    ...
    .learning_blocks_size = ei_learning_blocks_833783_2_size,
    .learning_blocks = ei_learning_blocks_833783_2,

    .postprocessing_blocks_size = ei_postprocessing_blocks_833783_2_size,
    .postprocessing_blocks = ei_postprocessing_blocks_833783_2,
    ...
    .freeform_outputs = freeform_outputs_833783_2
};

ei_impulse_handle_t impulse_handle_833783_2 = ei_impulse_handle_t( &impulse_833783_2 );

ei_impulse_handle_t& ei_default_impulse = impulse_handle_833783_2;
constexpr auto& ei_classifier_inferencing_categories = ei_classifier_inferencing_categories_833783_2;
const auto ei_dsp_blocks_size = ei_dsp_blocks_833783_2_size;
ei_model_dsp_t *ei_dsp_blocks = ei_dsp_blocks_833783_2;
